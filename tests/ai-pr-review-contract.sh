...
#    delete it. A bare allow-all-bots if: is a regression.
...
check 'grep -A30 "name: Security Check - Validate User Access" "$WF" | grep -qF "gh-app-write[bot]"' "access gate allowlists gh-app-write[bot]"
